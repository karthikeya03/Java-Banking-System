...
public class WithdrawUI {
    ...
    public void show() {
        ...
        amountField.setPromptText("Enter Withdraw Amount");
        ...
        withdrawButton.setStyle("-fx-background-color: #e94560; -fx-text-fill: white; -fx-font-weight: bold; -fx-border-radius: 5; -fx-background-radius: 5; -fx-pref-width: 200; -fx-pref-height: 38;");
        ...
        withdrawButton.setOnAction(e -> {
            ...
            try {
                ...
                boolean success = CustomerDAO.withdraw(customerId, amount);
        ...
        layout.getChildren().addAll(customerIdField, amountField, withdrawButton, messageLabel);
